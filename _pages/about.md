...
I have worked on building data- and cost-efficient pipelines on top of LLMs, by minimizing labelling and computing cost (most capable on consumer-level hardware with offline LLMs) to achieve comparable results across data preprocessing and tabular reasoning scenarios, including Entity Resolution, Tabular Representation Learning, Relation Extraction, and Table Question Answering. Relevant results were published in [[ICDE'26](https://authurlord.github.io/files/Conference/SPARQ_Camera_Ready.pdf), [KDD'24](https://authurlord.github.io/files/Conference/MELD_KDD24.pdf), [DASFAA'24](https://authurlord.github.io/files/Conference/DASFAA_Camera_Ready.pdf), [BigData'24](https://authurlord.github.io/files/Conference/UEADB_BigData.pdf) and [EMNLP'25](https://authurlord.github.io/files/Conference/PUER_EMNLP_Camera_Ready.pdf)].
